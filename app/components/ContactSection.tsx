...
function ContactSection() {
  ...
  const WHATSAPP_NUMBER = "923285094421";

  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();

    const message = `
New Website Project Inquiry – MagricSolutions
...
Please reply with next steps and available time slots for a strategy call.
    `.trim();
  ...
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-[#F7FFE9] py-20 md:py-24"
    >
          ...
          >
            ...
            <div className="mt-5">
              ...
              >
                ...
                <option value="New website for my business">
                  New website for my business
                </option>
                <option value="Redesign my existing website">
                  Redesign my existing website
                </option>
                <option value="Personal brand / portfolio website">
                  Personal brand / portfolio website
                </option>
                <option value="Landing page for a specific offer">
            ...
            <div className="mt-5">
              ...
              >
                ...
                <option value="PKR 30,000 – 60,000">PKR 30,000 – 60,000</option>
                <option value="PKR 60,000 – 120,000">PKR 60,000 – 120,000</option>
                <option value="PKR 120,000 – 250,000">PKR 120,000 – 250,000</option>
            ...
            <button
              type="submit"
              className="mt-7 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-black px-6 py-3.5 text-sm md:text-base font-semibold text-white shadow-lg transition-all hover:bg-gray-900 hover:shadow-xl"
            >
            ...
            <p className="mt-3 text-[11px] text-slate-500">
              When you submit, we’ll open WhatsApp with your message pre-filled. You can review and send it to us directly.
            </p>
          </motion.form>
        </div>
      </div>
